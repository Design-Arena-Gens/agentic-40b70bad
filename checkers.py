...
class Piece:
    ...
    def __repr__(self):
        return f"Piece({self.row}, {self.col}, {'WHITE' if self.color == WHITE else 'BLACK'}, {'KING' if self.king else 'NORMAL'})"
...
def main():
    ...
    while run:
        ...
        if game.winner() is not None:
            winner_text = "Белые победили!" if game.winner() == WHITE else "Черные победили!"
